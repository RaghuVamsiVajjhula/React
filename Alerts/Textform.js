...
export default function Textform(props) {
    ...
    return (
        ...
        <div className="container" style={{color: props.mode==='dark'?'white':'black' }}>
            <h1>{props.heading}</h1>
            <div className="mb-3">
                <textarea className="form-control" style={{ backgroundColor: props.mode ==='light'?'white':'grey'}} value={text} onChange={valueOnChange}id="exampleFormControlTextarea1" rows="8"></textarea>
            </div>
        ...
        <div className="container my-3 style={{props.mode==='dark'?'white':'black'}} ">
            <h1>Text Summary</h1>
